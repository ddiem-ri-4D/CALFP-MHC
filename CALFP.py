from EL_model import CALFP_EL
from BA_model import CALFP_BA
...
parser.add_argument('--BA', type=str, default='True', help='whether to predict binding affinity by BA data')
...
input_df = pd.read_parquet(args.input, columns=["Peptide", "HLA"])
input_df = input_df.rename(columns={"Peptide":"peptide", "HLA":"Allele Name"})
...
output_df = output_df.rename(columns={"peptide":"Peptide", "Allele Name":"HLA"})
